class Views::Contracts::Installments::Index < Views::Base
  ...
  def view_template
    render Views::Contracts::Installments::Modal.new
                ...
                div(class: "flex space-x-2") do
                  Remix::EditBoxLine(
                    ...
                    data: {
                      ...
                      controller: "resource",
                      resource_path_value: edit_contracts_installment_path(contract.id),
                      resource_dialogbutton_value: "installment-dialog-trigger"
                    }
                  )
                  Remix::BarChartBoxLine(
                    ...
                    data: {
                      action: "click->resource#triggerDialog",
                      controller: "resource",
                      resource_path_value: contracts_installment_path(contract.id),
