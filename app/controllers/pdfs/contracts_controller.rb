class Pdfs::ContractsController < ContractsController
  ...
  def create
    ctx = PawnContract::Operations::PdfBuilder.call(params: permit_params.to_h, current_user:)
    render json: { activity_id: ctx[:activity_id] }
  end

  def show
    ctx = PawnContract::Operations::PdfPrinter.call(params: print_params.to_h, current_user:)
