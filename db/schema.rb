...
ActiveRecord::Schema[8.0].define(version: 2025_08_30_170543) do
  ...
  create_table "asset_setting_services", id: { type: :string, limit: 27 }, force: :cascade do |t|
    t.string "asset_setting_id", null: false
    t.string "service_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["asset_setting_id"], name: "index_asset_setting_services_on_asset_setting_id"
    t.index ["service_id"], name: "index_asset_setting_services_on_service_id"
  end
  ...
  create_table "services", id: { type: :string, limit: 27 }, force: :cascade do |t|
    t.string "code"
    t.string "name"
    t.string "branch_id", null: false
    t.datetime "created_at", null: false
  ...
  add_foreign_key "asset_setting_services", "asset_settings"
  add_foreign_key "asset_setting_services", "services"
